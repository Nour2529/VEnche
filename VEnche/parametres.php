        ...
        <div class="card mx-auto mt-4" style="width: 40rem;">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="nom" name="nom" value="<?php echo htmlspecialchars($user['nom']); ?>" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label for="prenom" class="form-label">Prénom :</label>
                    <input type="text" id="prenom" name="prenom" value="<?php echo htmlspecialchars($user['prenom']); ?>" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label for="region" class="form-label">Région :</label>
                    <input type="text" id="region" name="region" value="<?php echo htmlspecialchars($user['region']); ?>" class="form-control">
                </div>
                <div class="mb-3">
                    <label for="pays" class="form-label">Pays :</label>
                    <input type="text" id="pays" name="pays" value="<?php echo htmlspecialchars($user['pays']); ?>" class="form-control">
                </div>
                <div class="mb-3">
                    <label for="adresse" class="form-label">Adresse :</label>
                    <input type="text" id="adresse" name="adresse" value="<?php echo htmlspecialchars($user['adresse']); ?>" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label for="numero_tel" class="form-label">Numéro de téléphone :</label>
                    <input type="tel" id="numero_tel" name="numero_tel" value="<?php echo htmlspecialchars($user['numero_tel']); ?>" class="form-control" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="mdp" name="mdp" value="<?php echo htmlspecialchars($user['mdp']); ?>" class="form-control" readonly>
 </div>
                <button type="submit" name="update_info" class="btn btn-primary">Enregistrer les modifications</button>
            </div>
        </div>
    </form>
</body>
